...
class _EditProfileViewState extends State<_EditProfileView> {
  ...
  Future<void> _openMultiSelect(
    ...
    final result = await showModalBottomSheet<List<String>>(
      ...
      backgroundColor: Colors.transparent,
      builder: (_) =>
          _MultiSelectSheet(title: title, options: options, initial: current),
    );
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  AppTextField(label: l10n.profileCity, controller: _cityCtrl),
                  const SizedBox(height: 16),
                  AppTextField(
                  ...
                  // Specializations
                  _ChipField(
                    label: l10n.profileSpecializations,
  ...
  void _onSearch(String q) {
    setState(() {
      _filtered = q.isEmpty
          ? _countryList
          : _countryList
                .where((c) => c.$1.toLowerCase().contains(q.toLowerCase()))
                .toList();
    });
  }
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Text(
                l10n.editProfileSelectCountryTitle,
            ...
            Padding(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  hintText: l10n.editProfileSearchCountryHint,
          ...
          children: [
            ...
            Padding(
              ...
              child: Row(
                children: [
                  Expanded(
                    child: Text(
                      l10n.editProfileSelectItemTitle(widget.title),
                      style: AppTextStyles.heading3,
                    ),
                  ),
                  TextButton(
                    ...
                    child: Text(
                      l10n.editProfileDoneCount(_selected.length),
                      style: AppTextStyles.bodyMedium.copyWith(
                        color: AppColors.primary,
                      ),
                    ),
            ...
            Padding(
              ...
              child: TextField(
                ...
                onChanged: _onSearch,
                decoration: InputDecoration(
                  hintText: l10n.editProfileSearchGenericHint,
                  hintStyle: AppTextStyles.body.copyWith(
                    color: AppColors.textSecondary,
                  ),
                  prefixIcon: const Icon(
            ...
            Padding(
              ...
              child: SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: Text(
                    l10n.editProfileApplyCount(_selected.length),
                    style: AppTextStyles.bodyMedium.copyWith(
                      color: Colors.white,
                    ),
                  ),
